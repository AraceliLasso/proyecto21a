...
export class RespuestaClaseDto {
    ...
    constructor(clase: Clase) {
        ...
        this.fecha = clase.fecha || null;
        this.disponibilidad = clase.disponibilidad;
        this.imagen = clase.imagen || null;
        this.perfilProfesor = clase.perfilProfesor 
            ? plainToClass(RespuestaPerfilProfesorDto, clase.perfilProfesor)
            : null;
        this.categoria = clase.categoria 
            ? plainToClass(RespuestaCategoriaDto, clase.categoria)
            : null;
    }
}
